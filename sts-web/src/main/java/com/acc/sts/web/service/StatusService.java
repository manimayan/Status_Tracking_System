...
public interface StatusService {
		...
		List<Clarify> searchTicket(Ticket ticket);

		Clarification updateComment(Clarification clarification);
		...
		List<Timereport> listNotReporttimeEmployee();

		List<Timereport> listNotReporttimeEmpabsence();
