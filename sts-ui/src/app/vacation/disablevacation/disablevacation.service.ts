...
@Injectable()
export class DisablevacationService {
...
Savepublicholidays(newaddedlist: any){
    
    console.log(newaddedlist);
    let headers = new Headers({ 'Content-Type': 'application/json' });
    let options = new RequestOptions({ withCredentials: true, headers: headers });;
    return this._http.post(this.rootUrl + 'vacation/savepublicholidays', newaddedlist, options)
